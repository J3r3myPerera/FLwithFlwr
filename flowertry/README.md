...
- **FedProx**: Handles data heterogeneity with proximal term regularization
...
alpha: 0.3          # Dirichlet parameter (lower = more heterogeneous)
...
### Non-IID Data Distribution (Latest)
...
- ✅ Automated comparison of FedAvg, FedProx, and FedSCAFFOLD
...
For detailed guidance on tuning FedProx and understanding performance differences, see:
- `FEDPROX_TUNING.md`: Comprehensive tuning guide
...
Class Distribution for First 5 Clients:
  Client 0:
    Low (<7%): 45 samples (52.3%)
    Medium (7-12%): 28 samples (32.6%)
    High (>12%): 13 samples (15.1%)
  ...
...
Strategy       Final Accuracy      Final Loss          Time (s)       
--------------------------------------------------------------------------------
FedAvg         57.55%              1.2345              45.23          
FedProx        59.12%              1.1892              47.15          

================================================================================
BEST STRATEGY (by accuracy): FedProx (59.12%)
================================================================================
```
...
**Version**: 2.0 (with Non-IID support and strategy comparison)
